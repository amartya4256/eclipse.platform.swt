...
private void drag(Event dragEvent) {
	...
	if (image != null) {
		...
		OS.ImageList_BeginDrag(ImageList.win32_getHandle(imagelist, zoom), 0, offsetX, event.offsetY);
		/*
		...
		*/
		...
		POINT pt = new POINT ();
		pt.x = DPIUtil.autoScaleUp(dragEvent.x, zoom);// To Pixels
		pt.y = DPIUtil.autoScaleUp(dragEvent.y, zoom);// To Pixels
