...
public Point computeSize (int wHint, int hHint, boolean changed){
	...
	return DPIUtil.scaleDown(computeSizeInPixels(wHint, hHint, changed), getZoom());
}
...
public Point toControl (int x, int y) {
	checkWidget ();
	return DPIUtil.scaleDown(toControlInPixels(DPIUtil.autoScaleUp(x, getZoom()), DPIUtil.autoScaleUp(y, getZoom())), getZoom());
}
...
public Point toControl (Point point) {
	...
	return DPIUtil.scaleDown(toControlInPixels(point.x, point.y), getZoom());
}
...
public Point toDisplay (int x, int y) {
	checkWidget ();
	return DPIUtil.scaleDown(toDisplayInPixels(DPIUtil.autoScaleUp(x, getZoom()), DPIUtil.autoScaleUp(y, getZoom())), getZoom());
}
...
public Point toDisplay (Point point) {
	...
	if (point == null) error (SWT.ERROR_NULL_ARGUMENT);
	point = DPIUtil.autoScaleUp(point, getZoom());
	return DPIUtil.scaleDown(toDisplayInPixels(point.x, point.y), getZoom());
}
