...
public Point computeSize (int wHint, int hHint) {
	...
	return DPIUtil.scaleDown(computeSizeInPixels(wHint, hHint), getZoom());
}
...
public void setPreferredSize (int width, int height) {
	checkWidget ();
	setPreferredSizeInPixels(DPIUtil.autoScaleUp(width, getZoom()), DPIUtil.autoScaleUp(height, getZoom()));
}
