...
public Point computeSize (int wHint, int hHint) {
	checkWidget ();
	wHint = (wHint != SWT.DEFAULT ? DPIUtil.autoScaleUp(wHint, parent.getZoom()) : wHint);
	hHint = (hHint != SWT.DEFAULT ? DPIUtil.autoScaleUp(hHint, parent.getZoom()) : hHint);
	return DPIUtil.autoScaleDown(computeSizeInPixels(wHint, hHint), parent.getZoom());
}
...
public Rectangle getBounds () {
	checkWidget ();
	return DPIUtil.autoScaleDown(getBoundsInPixels(), parent.getZoom());
}
...
public Point getPreferredSize () {
	checkWidget ();
	return DPIUtil.autoScaleDown(getPreferredSizeInPixels(), parent.getZoom());
}
...
public void setPreferredSize (int width, int height) {
	checkWidget ();
	setPreferredSizeInPixels(DPIUtil.autoScaleUp(width, parent.getZoom()), DPIUtil.autoScaleUp(height, parent.getZoom()));
}
...
public void setPreferredSize (Point size) {
	...
	size = DPIUtil.autoScaleUp(size, parent.getZoom());
...
public void setSize (int width, int height) {
	checkWidget ();
	setSizeInPixels(DPIUtil.autoScaleUp(width, parent.getZoom()), DPIUtil.autoScaleUp(height, parent.getZoom()));
}
...
void setSizeInPixels (int width, int height) {
	...
	*/
	if (!parent.isLastItemOfRow (index)) {
		...
		int separator = (parent.style & SWT.FLAT) == 0 ? DPIUtil.autoScaleUp(CoolBar.SEPARATOR_WIDTH , getZoom()) : 0;
...
public Point getMinimumSize () {
	checkWidget ();
	return DPIUtil.autoScaleDown(getMinimumSizeInPixels(), parent.getZoom());
}
...
public void setMinimumSize (int width, int height) {
	checkWidget ();
	setMinimumSizeInPixels(DPIUtil.autoScaleUp(width, parent.getZoom()), DPIUtil.autoScaleUp(height, parent.getZoom()));
}
